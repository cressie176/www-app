...
module.exports = new System({ name: 'routes', })
  ...
  .add('routes.feeds', feeds()).dependsOn('config', 'logger', 'app', 'auth', { component: 'cms.client', destination: 'cms', }, { component: 'cms.cache', destination: 'store', })
  .add('routes.client', client()).dependsOn('config', 'logger', 'app', { component: 'middleware.prepper', destination: 'prepper', }, 'auth')
  .add('routes').dependsOn('routes.admin', 'routes.publisher', 'routes.content', 'routes.feeds', 'routes.client');
